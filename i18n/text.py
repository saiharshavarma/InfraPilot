...
system_messages = {
    "welcome": "infrapilot: What can I help?",
    "ai_reasoning": "infrapilot reasoning: ",
    "response_prefix": "infrapilot: ",
    "inform_prefix": "infrapilot[inform]: ",
    "error_occur_message": "An internal error occurred. Enter 'infrapilot_log' if you want to see the details.",
...
def init_system_messages(llm: BaseLanguageModel):
    language = config.infrapilot_CONFIG.natural_language
